  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month_caption: "flex items-center justify-center h-[var(--cell-size)] w-full px-[var(--cell-size)]",
        dropdowns: "w-full flex items-center text-sm font-medium justify-center h-[var(--cell-size)] gap-1.5",
        ...
        week_number_header: "select-none w-[var(--cell-size)]",
